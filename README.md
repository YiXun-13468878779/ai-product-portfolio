...
把 AI 做成可感知的产品。从产品判断、交互与 Prompt，到可以真实体验的 Demo。

## 在线作品集

**[访问正式作品集](https://yixun-ai-portfolio.vercel.app)**
...
源码不依赖构建工具，可直接打开 `index.html` 预览，也可以部署到 Vercel、Netlify 或任意静态托管服务。

## About

王蓉静，西安交通大学。关注 AI 产品、AI 交互与 AI Coding，擅长将模糊概念整理成产品判断，并进一步实现为可体验、可讨论、可迭代的产品。
